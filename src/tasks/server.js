...
const template = 'Kevnz/app-template/templates/base'
...
module.exports = (name, root) =>
  message('@kev_nz')
    ...
    .then(() => {
      ...
      return npm.install(
        dependencies.dependencies.concat(serverDependencies.dependencies),
        {
          cwd: root,
          save: true,
        }
    ...
    .then(() => {
      ...
      return npm.install(
        dependencies.devDependencies.concat(serverDependencies.devDependencies),
        {
          cwd: root,
          saveDev: true,
        }
